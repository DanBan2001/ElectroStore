<?php
    ...
    if (!isset($_SESSION['acceso'])) {
     header("Location: robotica_sin_log.php")  ; 
    }
    ...
    $sql = $con->prepare("SELECT id, nombre, precio, id_categoria FROM productos WHERE id_categoria='Robotica' or id_categoria='Ofertas'");
    $sql->execute();
...
<link rel = "stylesheet" href="assets/css/styleFactura.css">
   ...
   <!---<div class="container-slider"> 
    ...
    <main class="main">
        <div class="container">
            <h2 class="main-title">Artículos para Robótica</h2>
            ...
            <div class="product">
                <?php
                    $id = $row['id'];
                    $imagen = "assets/img/productos_robotica/". $id ."/img.jpg";
