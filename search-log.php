<?php
   ...
   include_once("php/conexion_be.php");
    ...
    $sql = $con->prepare("SELECT id, nombre, precio,id_categoria FROM productos WHERE id_categoria='Teclado' ");
    $sql->execute();
...
<link rel = "stylesheet" href="assets/css/styleFactura.css">
        ...
        <div class="slider" id="slider">
            <div class="slider__section">
                ...
                <div class="slider__content">
                    ...
                    <a href="nuevo_sin_log.php" class="btn__shop">Comprar Ahora</a>
                </div>
            </div>
        <div class="slider__section">
    ...
    <main class="main">
        <div class="container">
            <h2 class="main-title"> Resultados para Teclados</h2>
            ...
            <div class="product">
                <?php
                    $id = $row['id'];
                    $imagen = "assets/img/productos_home/". $id . "/img.jpg";
               ...
               <a href="preview-productlog.php?id=<?php echo $row['id'];?>&token=<?php echo hash_hmac('sha1', $row['id'], KEY_TOKEN); ?>"><img src="<?php echo $imagen; ?>" alt="" class="product__img"> </a> 
                <div class="product__description">
                    <a href="" class="product__title"><h3 ><?php echo $row['nombre']; ?></h3></a>
...
<section class="container-tips">
        ...
        <footer class="main-footer">
           ...
           <div class="footer__section">
                ...
                <p class="footer__txt">Celular: +591 77777777</p>
            ...
            <div class="footer__section">
                ...
                <a href="https://wa.me/59173657823" class="footer__link">Reportar un error</a>
                <a href="" class="footer__link">Tienda</a>
                <a href="https://wa.me/59173657823" class="footer__link">Contactos</a>
            </div>
            <div class="footer__section">
