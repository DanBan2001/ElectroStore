            ...
            <div class="container container--flex">
                ...
                <h1 class="main-header__title">ElectroStore</h1>
                    ...
                    <nav class="main-nav" id="main-nav">
                        ...
                        <li class=menu__item><a href="computacional_sin_log.php" class="menu__link">Computacional</a></li>
                        <li class=menu__item><a href="robotica_sin_log.php" class="menu__link">Robótica</a></li>
                        <li class=menu__item><a href="gaming_sin_log.php" class="menu__link">Gaming</a></li>
                        </ul>
                    </nav>
                </div>
                <div class = "main-header__container">
