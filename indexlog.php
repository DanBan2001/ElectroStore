...
<link rel = "stylesheet" href="assets/css/styleFactura.css">
    ...
    <div class="container-slider"> 
        <div class="slider" id="slider">
            <div class="slider__section">
                ...
                <div class="slider__content">
                    ...
                    <a href="nuevo.php" class="btn__shop">Comprar Ahora</a>
                </div>
            </div>
        <div class="slider__section">
        ...
        <div class="slider__section">
                ...
                <div class="slider__content">
                   <h2 class="slider__title">Nuevos modelos para oficina</h2>
                    <p class="slider__txt">HP - DELL - APPLE</p>
        ...
        <div class="slider__section">
                ...
                <div class="slider__content">
                    ...
                    <a href="gaming.php" class="btn__shop">Comprar Ahora</a>
                </div>
            </div>
        </div>
    ...
    <main class="main">
        <div class="container">
            <h2 class="main-title">Artículos más vendidos</h2>
