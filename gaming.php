<?php
    ...
    if (!isset($_SESSION['acceso'])) {
     header("Location: gaming_sin_log.php")  ; 
    }
    ...
    $sql = $con->prepare("SELECT id, nombre, precio FROM productos_gamer WHERE id_categoria='Oficina'");
    $sql->execute();
...
<link rel = "stylesheet" href="assets/css/styleFactura.css">
    ...
    <main class="main">
        <div class="container">
            <h2 class="main-title">Artículos para los Gamer's</h2>
            ...
            <div class="product">
                <?php
                    $id = $row['id'];
                    $imagen = "assets/img/productos_gamer/". $id . "/img.jpg";
